...
{
    internal class ProcessOutputReader : IDisposable
    {
        ...
        internal ProcessOutputReader(Process p, StreamReader stream) : this(() => p.HasExited, stream)
        {
        }

        internal ProcessOutputReader(Func<bool> hostProcessExited, StreamReader stream)
        {
